...
const Footer: React.FC = () => {
  ...
  const textColor = theme.palette.mode === 'dark' ? theme.palette.text.primary : 'text.secondary';
  return (
    <Box
      component="footer"
      sx={{
        ...
        bgcolor: theme.palette.mode === 'dark' ? '#23201a' : undefined,
      }}
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
          ...
          />
          <Typography variant="h6" color={theme.palette.mode === 'dark' ? theme.palette.text.primary : brown} fontFamily="Lora, serif" fontWeight={700}>
            Mutare Diocese
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Link href="mailto:diomutare@gmail.com" underline="hover" sx={{ fontSize: '0.875rem', color: textColor }}>
            diomutare@gmail.com
          </Link>
        </Box>
      </Box>
      ...
      >
        <Typography variant="subtitle1" color={theme.palette.mode === 'dark' ? theme.palette.text.primary : brown} fontWeight={700} fontFamily="Lora, serif">
          Quick Links
        </Typography>
      ...
      >
        ...
        <Typography variant="body2" sx={{ color: textColor }} textAlign={{ xs: 'center', md: 'right' }}>
